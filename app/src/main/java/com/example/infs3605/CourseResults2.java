...
public class CourseResults2 extends AppCompatActivity {
    private Spinner spinner;
    String subjects[] = {"No Selection", "INFS1603 - Databases", "INFS1609 - Intro to Programming", "INFS2605 - Intermediate Programming"};
    int grade;
    EditText gradeInput;
    TextView gradeText;
    Button btnHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (!(spinner.getSelectedItem().toString().trim().equals("Select"))) {
                    ...
                    if (spinner.getSelectedItem().toString().trim().equals("INFS2605 - Intermediate Programming")) {
                        Toast.makeText(getApplicationContext(), "Please complete INFS1603 before taking this course", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        Intent intent = new Intent(this, HomePage3.class);
